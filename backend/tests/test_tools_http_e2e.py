...
http_requests = cast(Any, importlib.import_module("requests"))
...
class _CleanScanner:
    """Scanner double: every payload is CLEAN (fail-open for tests)."""
...
def _drive_to_done(  # noqa: PLR0913 - test helper threading 6 fixtures/params
    store: TaskStore,
    r2: R2Client,
    task_id: str,
    *,
